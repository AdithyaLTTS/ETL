"
SELECT A.COL_DiagSampleId , A.COL_LabNo , A.COL_FacilityId , A.COL_RegistrationId , A.COL_ServiceId , A.COL_SubDeptId , A.COL_DepartmentID , 
A.COL_EncounterId , A.COL_LabTechnicianId , B.COL_ResultDate , B.COL_FieldId , B.COL_ValueText , B.COL_ValueWordProcessor , B.COL_ValueId , 
B.COL_UnitId , B.COL_MinValue , B.COL_MaxValue , B.COL_SequenceNo , B.COL_ReviewedComments , C.COL_OrderNo , C.COL_OrderDate
FROM TBL_DiagSampleIPLabMain A , TBL_DiagInvResultIP B , TBL_ServiceOrderMain C  
WHERE A.COL_DiagSampleId = B.COL_DiagSampleId AND A.COL_OrderId = C.COL_Id  "
