"SELECT  X.COL_EncounterId , X.COL_RegistrationId , X.COL_OTSDate , X.COL_OTEDate , X.COL_OTRoomID , Z.COL_DepartmentId , A.COL_DepartmentName
FROM TBL_SurgeryOrder X , TBL_Admission Y  , TBL_Employee Z , TBL_DepartmentMain A
WHERE X.COL_EncounterId = Y.COL_EncounterId AND Y.COL_AdmittingDoctorId = Z.COL_ID AND Z.COL_DepartmentId = A.COL_DepartmentID"
