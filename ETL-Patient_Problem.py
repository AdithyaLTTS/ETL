...
B.COL_OPIP , B.COL_EncounterNo , B.COL_EncounterDate , B.COL_DoctorId , 
 D.COL_ProblemDescription
FROM TBL_Registration A , TBL_Encounter B ,   TBL_EMRPatientProblemDetails D 
WHERE A.COL_Id = B.COL_RegistrationId   AND A.COL_Id = D.COL_RegistrationId
AND B.Col_ID = D.COL_EncounterId  "
